				...
				if(responseObject.result!=null && responseObject.result.data.root!=null){
					...
					switch(petitionType){							
								...
								case GET_COLOCACION_EQUIPO:
									...
									var elemento_mayor_colocadoArray = elemento_mayor_colocado.split(' ');
									elemento_mayor_colocadoArray.shift();
									elemento_mayor_colocado = elemento_mayor_colocadoArray.join();
									
									var elemento_menor_colocadoArray = elemento_menor_colocado.split(' ');
									elemento_menor_colocadoArray.shift();
									elemento_menor_colocado = elemento_menor_colocadoArray.join();
